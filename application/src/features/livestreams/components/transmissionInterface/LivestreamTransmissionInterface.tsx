   ...
   return (
      <div className="flex justify-center mb-4 w-full">
         <p className="text-gray-500 text-sm">
            No hay sesión de preguntas y respuestas preparada para esta
            conferencia
         </p>
      </div>
   );
...
function LiveTransmissionHeader({
   isQna,
   conference,
}: {
   isQna: boolean;
   ...
   return (
      ...
      >
         <div className="flex items-center gap-3">
            <div
               className={`p-3 rounded-xl ${isQna ? "bg-green-500" : "bg-blue-500"}`}
            >
               {isQna ? (
         ...
         <div className="flex flex-col gap-2 p-2 !border !border-white rounded-lg *:w-full">
            ...
            <LinkButton
               target="_blank"
               href={`/live-transmission/${conference.id}/speaker-view/conference`}
               variant="white"
            >
               Ver conferencia
            </LinkButton>
            ...
            <LinkButton
               target="_blank"
               href={`/live-transmission/${conference.id}/speaker-view/QnA`}
               variant="white"
            >
         ...
         <div className="mx-auto max-w-7xl">
            ...
            >
               ...
               <div className="bg-white shadow-lg mb-6 p-6 border border-gray-200 rounded-2xl">
                  ...
                  >
                     {!isQna && (
                        <GoToQnASessionSection
                           qnaSession={qnaSession}
                           conferenceId={conferenceId}
                        />
                     )}
                     <LivestreamControlButtons
               ...
               <div className="gap-2 grid grid-cols-4">
                  ...
                  <div className="col-span-3">
                     ...
                     {activeQuestionPollId && (
                        <div className="bg-white shadow-lg mt-4 p-6 border border-gray-200 rounded-2xl">
                           ...
                           <SelfContainedRealtimeQuestionPollDisplay
                              conferenceId={conferenceId}
                           />
                        </div>
                     )}
                  ...
                  <div className="space-y-6">
                     ...
                     {/* Guest Link Section */}
                     {userIsAdmin && (
                        <CollapsibleGuestLink
                           streamingRoute={`/live-transmission/${conferenceId}/conference`}
                        />
                     )}
