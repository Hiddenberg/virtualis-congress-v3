   ...
   return (
      <div className="relative bg-black px-2 rounded-lg w-auto max-h-[80dvh] aspect-video overflow-hidden">
         ...
         <div className="items-center gap-2 grid grid-cols-12 h-full">
            <div className={`transition-all duration-300 ${state?.isHidden ? "col-span-0 w-0 overflow-hidden" : "col-span-10"}`}>
               <RealtimePresentationViewer presentationId={presentationId} showHeader={false} />
            </div>
