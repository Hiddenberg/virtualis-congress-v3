                     ...
                     {formattedDays.map((d, idx) => (
                        ...
                        >
                           <div className="flex items-center gap-3">
                              <div
                                 className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm ${idx === activeIdx ? "bg-white/20" : "bg-blue-100 text-blue-600"}`}
                              >
                                 {d.dayNum}
                              </div>
               ...
               <div className="mx-auto max-w-4xl">
                  <div className="bg-white shadow-lg p-4 md:p-8 border border-gray-200 rounded-2xl">
                     <div className="flex items-center gap-3 mb-6">
                        <div className="flex justify-center items-center bg-gradient-to-br from-blue-500 to-blue-600 rounded-full w-12 h-12">
                     ...
                     <div className="space-y-4 overflow-y-auto">
                        {current.conferences.map((conf) => (
                           <div
                              key={conf.id}
                              className="bg-white hover:shadow-lg border border-gray-200 hover:border-blue-300 rounded-xl overflow-hidden transition-all duration-300"
                           >
