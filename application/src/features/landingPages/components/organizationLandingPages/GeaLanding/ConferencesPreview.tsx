...
export default function ConferencesPreview({ conferences }: { conferences: ConferenceWithSpeakers[] }) {
   ...
   return (
      <div className="relative flex flex-col bg-black/20 shadow-2xl backdrop-blur-lg p-4 md:p-6 border border-white/20 rounded-2xl w-full max-w-md md:max-h-[90dvh] text-white">
         ...
         {current ? (
            ...
            <div className="text-cyan-100 text-sm">Pronto publicaremos el programa.</div>
         )}
      </div>
   );
}
