               ...
               <div className="mx-auto max-w-4xl">
                  <div className="bg-white shadow-lg p-4 md:p-8 border border-gray-200 rounded-2xl">
                     <div className="flex items-center gap-3 mb-6">
                        <div className="flex justify-center items-center bg-gradient-to-br from-teal-500 to-teal-600 rounded-full w-12 h-12">
                     ...
                     <div className="space-y-4 overflow-y-auto">
                        {current.conferences.map((conf) => (
                           ...
                           >
                              ...
                              <div className="bg-gradient-to-r from-teal-400 via-emerald-400 to-green-500 h-1" />
                           </div>
                        ))}
