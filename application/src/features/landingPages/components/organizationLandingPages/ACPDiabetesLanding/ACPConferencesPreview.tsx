            ...
            <div className="flex flex-col overflow-hidden">
               ...
               <div className="space-y-3 pr-1 overflow-y-auto">
                  {current.conferences.map((conf) => (
                     ...
                     >
                        <div className="flex flex-col items-start gap-3">
                           <div className="flex justify-center items-center bg-teal-300/20 py-1 rounded-md font-semibold text-teal-100 text-xs">
                  ...
                  {current.conferences.length === 0 && (
                     <div className="bg-white/10 p-4 border border-white/20 rounded-xl text-teal-100 text-sm text-center">
