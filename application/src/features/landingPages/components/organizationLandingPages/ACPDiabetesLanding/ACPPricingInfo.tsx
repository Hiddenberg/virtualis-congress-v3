         ...
         <div className="mx-auto px-4 container">
            ...
            <div className="gap-6 grid md:grid-cols-2 lg:grid-cols-5 mx-auto max-w-6xl">
               ...
               <div className="flex flex-col items-center bg-white hover:shadow-lg p-6 border-2 border-gray-100 hover:border-gray-200 rounded-2xl transition-all duration-300">
                  ...
                  <div className="bg-teal-50 mb-4 px-4 py-2 rounded-full font-bold text-teal-700 text-xl">$700</div>
               ...
               <div className="flex flex-col items-center bg-white hover:shadow-lg p-6 border-2 border-gray-100 hover:border-gray-200 rounded-2xl transition-all duration-300">
                  ...
                  <div className="bg-emerald-50 mb-4 px-4 py-2 rounded-full font-bold text-emerald-700 text-xl">$500</div>
                  <ul className="space-y-2 text-gray-600 text-sm">
                     <li>• Acceso a todas las conferencias en vivo</li>
                     <li>• Grabaciones incluidas</li>
                  </ul>
               ...
               <div className="flex flex-col items-center bg-white hover:shadow-lg p-6 border-2 border-gray-100 hover:border-gray-200 rounded-2xl transition-all duration-300">
                  ...
                  <div className="bg-green-50 mb-4 px-4 py-2 rounded-full font-bold text-green-700 text-xl">$400</div>
                  <ul className="space-y-2 text-gray-600 text-sm">
                     <li>• Acceso a todas las conferencias en vivo</li>
                     <li>• Grabaciones incluidas</li>
                  </ul>
               ...
               <div className="flex flex-col items-center bg-white hover:shadow-lg p-6 border-2 border-gray-100 hover:border-gray-200 rounded-2xl transition-all duration-300">
                  ...
                  <div className="bg-green-50 mb-4 px-4 py-2 rounded-full font-bold text-green-700 text-xl">$30 USD</div>
                  <ul className="space-y-2 text-gray-600 text-sm">
                     <li>• Acceso a todas las conferencias en vivo</li>
                     <li>• Grabaciones incluidas</li>
                  </ul>
               ...
               <div className="flex flex-col items-center bg-linear-to-br from-lime-50 to-green-50 hover:shadow-lg p-6 border-2 border-lime-200 hover:border-lime-300 rounded-2xl transition-all duration-300">
                  ...
                  <div className="bg-lime-100 mb-4 px-4 py-2 rounded-full font-bold text-lime-700 text-xl">Sin costo</div>
                  <ul className="space-y-2 text-gray-600 text-sm">
                     <li>• Acceso a todas las conferencias en vivo</li>
                     <li>• Grabaciones incluidas</li>
                  </ul>
