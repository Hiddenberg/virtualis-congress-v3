...
export default function SelfContainedRealtimeQuestionPollCompactDisplay({ conferenceId }: { conferenceId: string }) {
   const { data, isLoading } = useConferenceActiveQuestionPollRealtime(conferenceId);
      ...
      return (
         <div className="bg-white/70 shadow-sm p-4 border border-slate-300 rounded-2xl">
            <div className="flex items-center gap-3">
               ...
               <span className="font-medium text-slate-600">Cargando encuesta...</span>
            </div>
         </div>
      );
   }
      ...
      return (
         <div className="bg-white/70 shadow-sm p-4 border border-slate-300 rounded-2xl">
            <div className="flex justify-center items-center py-2">
               <span className="font-medium text-slate-500 text-sm">No hay encuesta activa para mostrar</span>
            </div>
         </div>
      );
