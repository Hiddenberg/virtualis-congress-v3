...
export default function ConferenceSchedule({ startTime, endTime }: { startTime: string; endTime: string }) {
      ...
      <div className="space-y-2 text-sm">
         <div className="flex items-center gap-2 text-gray-700">
            <span className="inline-flex items-center gap-2 bg-gray-50 px-3 py-1.5 rounded-md ring-1 ring-gray-200">
               ...
               <span className="font-medium text-gray-900">{conferenceDateText}</span>
            </span>
         </div>
         <div className="flex items-center gap-2 text-gray-700">
            <span className="inline-flex items-center gap-2 bg-blue-50 px-3 py-1.5 rounded-md ring-1 ring-blue-200">
               ...
               <span className="tabular-nums text-blue-700">{startTimeText}</span>
