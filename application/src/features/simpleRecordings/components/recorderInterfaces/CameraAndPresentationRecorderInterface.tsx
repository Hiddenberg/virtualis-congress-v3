...
export default function CameraAndPresentationRecorderInterface({
   ...
   if (recorderStage === "join_session") {
      return (
         <div className="justify-center! items-center! bg-linear-to-br! from-blue-50! to-indigo-50! p-4! min-h-screen! flex!">
            <div className="flex-col! bg-white! shadow-xl! mx-auto! p-8! rounded-2xl! w-full! max-w-md! flex!">
               <div className="flex-col! gap-6! flex!">
                  ...
                  <Button
                     ...
                     className="justify-center! items-center! gap-2! bg-linear-to-r! from-blue-500! hover:from-blue-600! to-blue-600! hover:to-blue-700! py-4! rounded-xl! w-full! font-semibold! text-white! hover:scale-105! active:scale-95! transition-all! duration-200! flex! transform!"
                  >
   ...
   if (recorderStage === "presentation_info") {
      return (
         <div className="justify-center! items-center! bg-linear-to-br! from-purple-50! to-pink-50! p-4! min-h-screen! flex!">
            <div className="flex-col! bg-white! shadow-xl! mx-auto! p-8! rounded-2xl! w-full! max-w-lg! flex!">
               <div className="flex-col! gap-6! flex!">
                  <div className="text-center!">
                     <div className="bg-purple-100! mx-auto! mb-4! p-3! rounded-full! w-16! h-16!">
                        <FileText className="mx-auto! size-10! text-purple-600!" />
                     </div>
                     <h3 className="mb-2! font-bold! text-2xl! text-gray-900!">Sobre tus diapositivas</h3>
                  ...
                  <div className="space-y-4!">
                     {/* <h4 className="font-semibold! text-center! text-gray-800!">¿Tus diapositivas contienen videos?</h4> */}

                     <div className="gap-3! grid-cols-1! grid!">
                        <button
                           type="button"
                           onClick={() => {
                     ...
                     {presentationHasVideo !== null && (
                        <div className="bg-amber-50! mt-4! p-4! border-amber-200! rounded-xl! border!">
                  ...
                  <div className="!sm:flex-row flex-col! gap-3! mt-6! flex!">
                     <Button
                        variant="secondary"
                        onClick={() => setRecorderStage("join_session")}
                        className="justify-center! items-center! gap-2! py-3! rounded-xl! w-full! !sm:w-auto font-medium! flex!"
                     >
                        Atrás
                     </Button>
                     ...
                     <Button
                        ...
                        className="justify-center! items-center! gap-2! bg-linear-to-r! from-purple-500! hover:from-purple-600! to-purple-600! hover:to-purple-700! py-3! rounded-xl! w-full! font-semibold! text-white! hover:scale-105! active:scale-95! transition-all! duration-200! flex! transform!"
                     >
                        Continuar <ArrowRight size={20} />
                     </Button>
                  </div>
