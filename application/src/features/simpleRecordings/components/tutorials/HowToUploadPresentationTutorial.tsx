...
const steps: TutorialStep[] = [
   {
      description: "Haz click o arrastra tu archivo de powerpoint en la sección de subir diapositiva",
      imageURL: "https://res.cloudinary.com/dnx2lg7vb/image/upload/v1760219059/presentation-1_rinqu8.webp",
   ...
   },
   {
      ...
      imageURL: "https://res.cloudinary.com/dnx2lg7vb/image/upload/v1760219058/presentation-2_z0ycwx.webp",
   },
   {
      description: `Espera a que el sistema procese el archivo`,
      imageURL: "https://res.cloudinary.com/dnx2lg7vb/image/upload/v1760219058/presentation-3_u3xsok.webp",
   ...
   },
   {
      ...
      imageURL: "https://res.cloudinary.com/dnx2lg7vb/image/upload/v1760219059/presentation-4_r5cnxg.webp",
      notes: `Si quieres subir una diapositiva distinta, puedes hacer click en "Convertir otra presentación"`,
   },
];

export default function HowToUploadPresentationTutorial({ onFinish }: { onFinish: () => void }) {
   return (
      <TutorialSlider
