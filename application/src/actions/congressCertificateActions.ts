...
import {
   checkIfUserWasCoordinator,
   checkIfUserWasSpeaker,
   createCongressCertificate,
} from "@/features/certificates/services/certificateServices";
...
export async function createCongressCertificateAction(
   ...
   try {
      ...
      if (wasSpeaker) {
         ...
         console.log(
            "[Congress Certificate Actions] User was speaker, creating speaker certificate",
            userId,
         );
      }
      ...
      if (wasCoordinator) {
         ...
         console.log(
            "[Congress Certificate Actions] User was coordinator, creating coordinator certificate",
            userId,
         );
      }
