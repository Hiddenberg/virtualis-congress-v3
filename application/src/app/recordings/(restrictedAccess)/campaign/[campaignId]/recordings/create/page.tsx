...
export default async function CreateRecordingPage({ params }: { params: Promise<{ campaignId: string }> }) {
      ...
      return (
         <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8 max-w-7xl">
            <div className="bg-red-50 mx-auto p-8 border border-red-200 rounded-xl max-w-md text-center">
               ...
               <p className="mb-4 text-red-700">No se pudo encontrar la campaña especificada.</p>
               <Link
                  href="/recordings"
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8 max-w-7xl">
         ...
         <div className="mb-6">
            <div className="flex items-center gap-2 text-sm">
               ...
               <Link href={`/recordings/campaign/${campaignId}`} className="text-gray-600 hover:text-gray-900 transition-colors">
                  {campaign.title}
               </Link>
               <span className="text-gray-400">/</span>
         ...
         <div className="bg-blue-50 mb-8 p-4 border border-blue-200 rounded-lg">
            <div className="flex items-center gap-3">
               ...
               <div>
                  <p className="font-medium text-blue-900 text-sm">Creando grabación en la campaña:</p>
                  <p className="font-semibold text-blue-700">{campaign.title}</p>
               </div>
            </div>
         </div>
         ...
         <div className="mb-8 text-center">
            ...
            <h1 className="mb-2 font-bold text-gray-900 text-3xl">Programar nueva grabación</h1>
            <p className="mx-auto max-w-2xl text-gray-600 text-lg">
               Completa la información para programar una nueva grabación. Se enviará una invitación al grabador con las
               instrucciones.
            </p>
         </div>
