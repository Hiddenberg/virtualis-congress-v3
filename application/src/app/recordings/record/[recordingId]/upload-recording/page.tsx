...
export default async function UploadRecordingPage({
         ...
         <div className="flex justify-center items-center min-h-screen">
            <div className="text-center">
               ...
               <p className="text-gray-600">
                  La grabación que buscas no existe o no tienes permisos para
                  acceder a ella.
               </p>
            </div>
         </div>
   ...
   const loomLogoURL =
      "https://res.cloudinary.com/dnx2lg7vb/image/upload/v1757811845/c5f8d8b2-245f-40a3-8c9e-00feb91b2281.webp";
            ...
            <div className="bg-white shadow-sm mb-6 p-6 border border-gray-200 rounded-xl">
               <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                     ...
                     <p className="text-gray-600">
                        Graba tu video con cualquier herramienta y súbelo aquí
                        en formato MP4.
                     </p>
                  </div>
               </div>
            ...
            <div className="mt-6 text-center">
               <div className="bg-blue-50 p-4 border border-blue-200 rounded-lg">
                  ...
                  <p className="text-blue-700 text-sm">
                     Audio claro • Buena iluminación • Formato MP4 • Mínimo 720p
                  </p>
               </div>
            </div>
         </div>
