...
import { RecordAgainButton, ReviewRecordingButtons } from "@/features/simpleRecordings/components/ReviewRecordingButtons";
   ...
   if (recording.status === "error") {
      return (
         <div className="flex justify-center items-center bg-gray-50 p-4 min-h-screen">
            <div className="bg-white shadow-lg p-8 rounded-xl w-full max-w-md text-center">
               <AlertCircle className="mx-auto mb-4 size-12 text-red-500" />
               <h1 className="mb-2 font-semibold text-gray-900 text-xl">Error al subir la grabación</h1>
               <p className="text-gray-600">La grabación no se pudo subir a nuestro servidor. Por favor, vuelve a intentarlo</p>
               {recording.errorMessage && <p className="text-gray-600">{recording.errorMessage}</p>}
   ...
   if (recording.status !== "uploading" && !recording.muxPlaybackId) {
      return (
         <div className="flex justify-center items-center bg-gray-50 p-4 min-h-screen">
            <div className="bg-white shadow-lg p-8 rounded-xl w-full max-w-md text-center">
               <Clock className="mx-auto mb-4 size-12 text-amber-500" />
               <h1 className="mb-2 font-semibold text-gray-900 text-xl">La grabación se está subiendo</h1>
               <p className="text-gray-600">
                  Tu grabación se está subiendo a nuestro servidor. Por favor, vuelve a intentar en unos minutos.
               </p>
            </div>
         </div>
      );
            ...
            <div className="gap-2 grid grid-cols-1">
               ...
               <div className="bg-white shadow-sm p-6 border border-gray-200 rounded-xl">
                  <div className="space-y-2 text-center">
                     <div>
                        <h2 className="font-semibold text-gray-900 text-lg">¿Estás satisfecho con tu grabación?</h2>
                        <div className="bg-blue-50 mt-3 p-4 border border-blue-200 rounded-lg text-center">
                           <p className="font-semibold text-blue-900">Por favor, revisa tu grabación en la parte inferior.</p>
               ...
               {/* Video Player */}
               <div className="bg-white shadow-sm mx-auto border border-gray-200 rounded-xl w-[80dvh]">
