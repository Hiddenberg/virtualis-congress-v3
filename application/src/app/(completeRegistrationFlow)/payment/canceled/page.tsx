         ...
         <div className="mx-auto max-w-2xl">
            ...
            <div className="mb-4 sm:mb-6 md:mb-8 text-center">
               <div className="flex justify-center items-center bg-red-100 mx-auto mb-3 sm:mb-4 md:mb-6 rounded-full w-16 sm:w-20 md:w-20 h-16 sm:h-20 md:h-20">
                  <XCircle className="w-8 sm:w-10 h-8 sm:h-10 text-red-600" />
               </div>
            ...
            <div className="bg-white shadow-lg mb-4 sm:mb-6 border border-gray-100 rounded-xl sm:rounded-2xl overflow-hidden">
               ...
               <div className="bg-linear-to-r from-red-600 to-orange-600 p-4 sm:p-6 text-white">
                  <div className="flex items-center gap-2 sm:gap-3">
                     <CreditCard className="w-5 sm:w-6 h-5 sm:h-6 shrink-0" />
               ...
               <div className="space-y-4 sm:space-y-6 p-4 sm:p-6">
                  <div className="bg-orange-50 p-3 sm:p-4 border border-orange-200 rounded-lg">
                     <div className="flex items-start gap-2 sm:gap-3">
                        <XCircle className="mt-0.5 w-4 sm:w-5 h-4 sm:h-5 text-orange-600 shrink-0" />
                        <div className="flex-1 min-w-0">
                  ...
                  <div className="pt-4 sm:pt-6 border-gray-200 border-t">
                     <h3 className="flex items-center gap-2 mb-3 sm:mb-4 font-semibold text-gray-900 text-base sm:text-lg">
                        <HelpCircle className="w-4 sm:w-5 h-4 sm:h-5 shrink-0" />
                        Posibles Razones
                     </h3>
            ...
            <div className="bg-white shadow-lg mb-4 sm:mb-6 p-4 sm:p-6 border border-gray-100 rounded-xl sm:rounded-2xl">
               <h3 className="flex items-center gap-2 mb-3 sm:mb-4 font-semibold text-gray-900 text-base sm:text-lg">
                  <RefreshCw className="w-4 sm:w-5 h-4 sm:h-5 text-blue-600 shrink-0" />
                  ¿Qué puedes hacer ahora?
               </h3>
               <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-start gap-2 sm:gap-3 bg-green-50 p-3 rounded-lg">
                     <CreditCard className="mt-0.5 w-4 sm:w-5 h-4 sm:h-5 text-green-600 shrink-0" />
                     <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-start gap-2 sm:gap-3 bg-blue-50 p-3 rounded-lg">
                     <HelpCircle className="mt-0.5 w-4 sm:w-5 h-4 sm:h-5 text-blue-600 shrink-0" />
                     <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-start gap-2 sm:gap-3 bg-purple-50 p-3 rounded-lg">
                     <Mail className="mt-0.5 w-4 sm:w-5 h-4 sm:h-5 text-purple-600 shrink-0" />
                     <div className="flex-1 min-w-0">
