      ...
      <div className="flex justify-center items-center bg-linear-to-br from-gray-50 to-gray-100 p-4 w-full min-h-screen">
         <div className="bg-white shadow-xl p-8 md:p-10 border border-gray-200 rounded-2xl w-full max-w-lg">
            <div className="mb-10 text-center">
               <h1 className="mb-3 font-bold text-gray-800 text-3xl tracking-tight">¡Bienvenido de nuevo!</h1>
               <p className="text-gray-600 text-base leading-relaxed">Ingresa tu correo electrónico para continuar</p>
            </div>
            ...
            <div className="mt-10">
               ...
               <div className="bg-linear-to-r from-gray-50 to-blue-50 shadow-sm p-6 border-2 border-gray-200 rounded-2xl text-center">
                  <p className="mb-4 font-semibold text-gray-800 text-lg">¿No tienes una cuenta?</p>
                  <a
                     href="/signup"
