...
export default async function UploadedPresentationPage({
   params,
}: {
      ...
      <div className="flex justify-center items-center p-6 min-h-[60vh]">
         <div className="bg-white shadow-sm p-8 border border-gray-200 rounded-2xl w-full max-w-lg text-center">
            ...
            <h1 className="mb-2 font-bold text-gray-900 text-2xl">
               ¡Presentación subida correctamente!
            </h1>
            <p className="text-gray-600">
               Gracias por compartir tus materiales. Tu presentación quedó
               registrada para tu conferencia como:
            </p>
               ...
               <div className="bg-gray-50 p-5 border border-gray-200 rounded-xl">
                  <div className="flex items-start gap-3">
                     ...
                     <div className="flex-1">
                        ...
                        <p className="text-gray-600">
                           Las encuestas ayudan a interactuar con la audiencia
                           durante tu conferencia.
                        </p>
                        <div className="flex sm:flex-row flex-col sm:items-center gap-3 mt-4">
                           <LinkButton
                              href={`/preparation/${conferenceId}/question-polls`}
                              variant="blue"
                              className=""
                           >
                        ...
                        <p className="mt-3 text-gray-500 text-sm">
                           Si no deseas hacerlo ahora, puedes cerrar esta
                           ventana manualmente.
                        </p>
                     </div>
                  </div>
