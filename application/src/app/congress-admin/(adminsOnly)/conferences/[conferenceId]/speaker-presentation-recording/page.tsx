...
export default async function SpeakerPresentationRecordingPage({
   params,
}: {
   ...
   const speakerPresentationRecording =
   ...
   return (
      <div className="p-6">
         <GoBackButton
            className="mb-6"
            backURL="/congress-admin/conferences"
            backButtonText="Volver a conferencias"
         />
         ...
         {speakerPresentationRecording ? (
            <div className="space-y-6">
                  ...
                  <div className="flex justify-between items-start mb-6">
                     <div className="flex-1">
                        <h2 className="mb-2 font-bold text-gray-900 text-xl">
                           Grabación de la presentación del ponente
                        </h2>
                        <p className="mb-3 text-gray-600">
                           {speakerPresentationRecording.title}
                        </p>
                     ...
                     <UnlinkSpeakerPresentationRecordingButton
               ...
               {/* Video Player Card */}
               {speakerPresentationRecording.status === "ready" &&
                  speakerPresentationRecording.muxPlaybackId && (
                     <div className="bg-white shadow-sm p-6 border border-gray-200 rounded-lg">
                        <div className="mb-4">
                           ...
                           <p className="text-gray-600 text-sm">
                              Visualiza la grabación de la presentación del
                              ponente
                           </p>
                        </div>
            ...
            <div className="bg-white shadow-sm p-8 border border-gray-200 rounded-lg">
               <div className="text-center">
                  ...
                  <h2 className="mb-2 font-bold text-gray-900 text-xl">
                     No hay presentación del ponente vinculada
                  </h2>
                  <p className="mb-6 text-gray-600">
                     Vincula una grabación de presentación para que esté
                     disponible en esta conferencia
                  </p>
                  <LinkButton
