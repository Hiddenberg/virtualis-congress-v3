...
export default function CongressEndedBanner({ congress, hasAccessToRecordings }: CongressEndedBannerProps) {
   return (
      <div className="flex flex-col justify-center items-center p-4 md:p-8">
         <div className="w-full max-w-3xl">
            <div className="bg-linear-to-br from-blue-50 to-white shadow-sm p-6 md:p-8 border border-blue-100 rounded-2xl text-center">
               ...
               <h1 className="mb-2 font-bold text-slate-800 text-2xl md:text-3xl">{congress.title}</h1>
               <p className="mb-4 font-semibold text-blue-800 text-lg md:text-xl">¡El congreso ha finalizado!</p>
               <p className="mb-6 text-slate-600 text-base md:text-lg">
                  ¡Felicitaciones por tu participación! Esperamos que hayas disfrutado y aprendido mucho.
               </p>
               <p className="mb-6 text-slate-600 text-base md:text-lg">
