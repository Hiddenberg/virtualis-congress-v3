...
export default function RecordingsBanner() {
   return (
      <div className="relative bg-linear-to-r from-gray-100 to-gray-50 shadow-md px-4 sm:px-6 md:px-8 py-6 sm:py-8 border-2 border-blue-500 rounded-xl sm:rounded-2xl md:rounded-3xl overflow-hidden">
         <div
