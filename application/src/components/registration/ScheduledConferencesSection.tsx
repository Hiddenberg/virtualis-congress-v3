...
export default function ScheduledConferencesSection({ congressDates, conferencesMap }: ScheduledConferencesSectionProps) {
   const [selectedDay, setSelectedDay] = useState<Date | null>(congressDates.length > 0 ? congressDates[0] : null);
   ...
   const selectedDayConferences = selectedDay ? conferencesMap[selectedDayFormatted] || [] : [];
      ...
      <section className="px-4 md:px-10 py-12">
         <div className="mx-auto max-w-6xl">
            <div className="mb-10 text-center">
               <h2 className="mb-4 font-bold text-blue-900 text-3xl">Conferencias Programadas</h2>
               <p className="mb-8 text-gray-600">Selecciona un día para ver las conferencias programadas</p>
               ...
               {selectedDayConferences.length > 0 ? (
                  selectedDayConferences.map((conference, index) => {
                     ...
                     return (
                        ...
                        >
                           <h3 className="mb-2 font-bold text-blue-900 text-lg">{conference.title}</h3>
                           <p className="mb-4 text-gray-600">{conference.shortDescription}</p>
                           ...
                           <div className="flex flex-col space-y-4">
                                 ...
                                 <div className="flex items-center">
                                    <div className="flex items-center gap-2 bg-blue-100 px-3 py-2 rounded-lg">
                                       ...
                                       <span className="font-semibold text-blue-800 text-base">
                                          {format(new Date(conference.startTime), "hh:mm A", "es-MX")}
                                       </span>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div className="flex items-start gap-2">
                                 <Users size={18} className="mt-1 text-blue-700 shrink-0" />
                                 <div className="flex flex-col">
                                    ...
                                    <div className="flex flex-wrap gap-1 mt-1">
                                       {conference.speakers && conference.speakers.length > 0 ? (
                                          ...
                                          <span className="text-gray-500 text-sm">No hay ponentes asignados</span>
                                       )}
                                    </div>
                                 </div>
                              </div>
                  ...
                  <div className="col-span-full bg-gray-50 py-10 rounded-xl text-center">
                     <p className="text-gray-500">No hay conferencias programadas para este día</p>
                  </div>
               )}
            </div>
         </div>
