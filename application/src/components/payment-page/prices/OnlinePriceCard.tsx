...
export default function OnlinePriceCard({ price, index }: OnlinePriceCardProps) {
   ...
   return (
      <Link
         ...
         className="group relative flex flex-col justify-between items-center bg-white hover:shadow-xl p-6 border-2 border-gray-100 hover:border-blue-300 rounded-2xl transition-all hover:-translate-y-1 duration-300"
      >
