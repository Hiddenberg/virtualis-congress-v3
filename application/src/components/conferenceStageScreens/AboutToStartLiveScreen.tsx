...
export default function AboutToStartLiveScreen({ conferenceTitle, startTime }: AboutToStartLiveScreenProps) {
   ...
   return (
      <div className="flex flex-col justify-center items-center bg-blue-50 mb-4 p-4 border border-blue-200 rounded-lg aspect-video">
         <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold text-blue-900 text-lg">El anfitrión está preparando la transmisión</h2>
         </div>
         ...
         <div className="flex flex-col justify-center items-center gap-2 mt-4 w-full max-w-xl">
            <p className="font-medium text-blue-700 text-center">La transmisión comenzará en cuanto el anfitrión la inicie.</p>
