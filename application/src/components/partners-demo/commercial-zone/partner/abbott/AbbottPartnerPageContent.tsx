      ...
      <div className="relative bg-amber-50 p-5 border border-amber-200 rounded-2xl">
         ...
         <div className="flex flex-col items-start gap-4">
            <div className="place-items-center grid bg-gray-800 rounded-xl size-36">
               <Image
                  src={PARTNERS_DEMO_CONSTANTS.ABBOTT_LOGO_URL}
                  alt="Abbott logo"
                  width={80}
                  height={80}
                  unoptimized
   ...
   return (
      ...
      >
         <div className="flex items-start gap-3">
            <div className="place-items-center grid bg-amber-300 rounded-full w-9 h-9 text-slate-900">
               {icon}
            </div>
            <div>
   ...
   const actions: ActionItem[] = [
      {
         ...
         description:
            "Accede a ofertas y descuentos especiales en productos Abbott, solo para asistentes del congreso.",
      },
      {
         icon: <Trophy size={18} />,
         title: "Participa en nuestro Sorteo",
         description:
            "Participa y gana productos Abbott exclusivos. ¡Descubre más aquí!",
      },
      {
