...
export default function ConferenceCard({
   ...
   if (link) {
      return (
         <Link
            href={link}
            className={`relative flex h-full flex-col rounded-2xl border p-4 shadow-sm ${COLOR_MAP[color]}`}
         >
            ...
            <h3 className="mt-3 font-medium text-gray-900 text-sm md:text-base line-clamp-2">
               {title}
            </h3>
